...
namespace DigiMarket.Persistence.Migrations
{
    ...
    partial class DigiMarketContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DigiMarket.Domain.Entities.Finances.RequestPay", b =>
                {
                    b.Property<int>("KeyId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DigiMarket.Domain.Entities.Orders.Order", b =>
                {
                    b.Property<int>("KeyId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DigiMarket.Domain.Entities.Orders.OrderDetail", b =>
                {
                    b.Property<int>("KeyId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DigiMarket.Domain.Entities.Orders.Order", b =>
                {
                    b.HasOne("DigiMarket.Domain.Entities.Finances.RequestPay", "RequestPay")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("DigiMarket.Domain.Entities.Orders.OrderDetail", b =>
                {
                    b.HasOne("DigiMarket.Domain.Entities.Orders.Order", "Order")
                        .WithMany()
