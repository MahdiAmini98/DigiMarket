...
{
    public partial class MI_Order : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address = table.Column<string>(type: "nvarchar(max)", maxLength: 50000, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Orders", x => x.KeyId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderDetails", x => x.KeyId);
                    table.ForeignKey(
